function [R1, R2, C1, C2] = FilterDesignerSallenKeyHP(Fc, Coeff, ForcedComponent)
    % FILTERDESIGNERSALLENKEYHP Compute values of component for a given high pass filter Sallen Key.
    % 
    ...
    if startsWith(ForcedComponent, 'R=')
        error("This equation is not solvable, please assert that both C are equivalent by setting a value.")
